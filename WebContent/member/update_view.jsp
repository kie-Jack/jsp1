        ...
        <form action="update_save.jsp" name="frmReg" method="post"
            ...
            <table style="width:100%; margin: auto;">
                <tr>
                    ...
                    <td><input type="text" name="name" placeholder="이름 입력(필수)" value="<%=cus.getName() %>"readonly></td>			<!-- readonly : 읽기만. 입력못합니다. -->
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name="age" min="10" max="99" value="<%=cus.getAge()%>" readonly></td>   
